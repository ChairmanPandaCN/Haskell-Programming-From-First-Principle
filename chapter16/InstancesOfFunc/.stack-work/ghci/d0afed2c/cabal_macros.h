...
/* package InstancesOfFunc-0.1.0.0 */
#ifndef VERSION_InstancesOfFunc
#define VERSION_InstancesOfFunc "0.1.0.0"
#endif /* VERSION_InstancesOfFunc */
#ifndef MIN_VERSION_InstancesOfFunc
#define MIN_VERSION_InstancesOfFunc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_InstancesOfFunc */
...
#define CURRENT_COMPONENT_ID "InstancesOfFunc-0.1.0.0-HVhWQNHotKJ9Xr8XEilroj-InstancesOfFunc"
