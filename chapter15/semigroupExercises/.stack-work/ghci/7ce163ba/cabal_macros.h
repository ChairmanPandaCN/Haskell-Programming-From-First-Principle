...
/* package semigroupExercises-0.1.0.0 */
#ifndef VERSION_semigroupExercises
#define VERSION_semigroupExercises "0.1.0.0"
#endif /* VERSION_semigroupExercises */
#ifndef MIN_VERSION_semigroupExercises
#define MIN_VERSION_semigroupExercises(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_semigroupExercises */
...
#define CURRENT_COMPONENT_ID "semigroupExercises-0.1.0.0-I5FMPZp4tOAIwInwZwNE4a-semigroupExercises"
