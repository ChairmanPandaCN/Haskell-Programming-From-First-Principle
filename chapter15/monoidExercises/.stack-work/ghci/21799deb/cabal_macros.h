...
/* package monoidExercises-0.1.0.0 */
#ifndef VERSION_monoidExercises
#define VERSION_monoidExercises "0.1.0.0"
#endif /* VERSION_monoidExercises */
#ifndef MIN_VERSION_monoidExercises
#define MIN_VERSION_monoidExercises(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_monoidExercises */
...
#define CURRENT_COMPONENT_ID "monoidExercises-0.1.0.0-KuRpEC1VbrSEAUg7D7KSVT-monoidExercises"
